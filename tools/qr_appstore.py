...
SORTIE = RACINE / "qr-appstore-quittance.svg"

# Jeton distinct de celui du badge : un scan et un clic ne disent pas la
# même chose, et les confondre rendrait la mesure inexploitable.
URL = ("https://apps.apple.com/app/apple-store/id6772793420"
       "?pt=128946892&ct=quittance_qr&mt=8")
